...
class ONC_no_max_scan:
    ...
    """
    def __init__(self, correlation_matrix: pd.DataFrame, repeat: int = 10):
        """
    ...
    def fit(self):
        ...
        corr_matrix, opt_clusters, silh_scores = self._cluster_kmeans_top(self.correlation, self.repeat)
    ...
    def plot_block_correlation(self, save: bool = False, pre_fix: str = '0'):
        ...
        """
        # Plot the correlation matrix using a divergent color palette.
        sns.heatmap(self.__block_correlation, cmap='RdBu',
    ...
    def _cluster_kmeans_top(self, corr_mat: pd.DataFrame, repeat: int = 10) -> Tuple[pd.DataFrame, Dict, pd.Series]:
        """
        ...
        if len(redo_clusters) <= 2:
            ...
            # Recursive call
            _, top_clusters, _ = self._cluster_kmeans_top(corr_tmp, repeat=repeat)
    ...
    def _kmeans_base(corr: pd.DataFrame, max_num_clusters: int,
        ...
        # Number of clusters equal to length(kmeans labels)
